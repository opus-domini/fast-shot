...
// BodyWrapper is the interface that wraps the basic methods for managing HTTP request bodies.
//
// This wrapper provides a unified interface for handling request bodies,
// abstracting away the complexities of different body types and serialization methods.
//
// It allows the library to implement various body handling strategies
// (e.g., streaming, buffering, automatic serialization) without changing the public API.
// It also facilitates easier testing and mocking of body-related functionality.
//
// Example:
//
...
//	}
//
//	func (w *StreamingBodyWrapper) SetAsJSON(obj interface{}) error {
