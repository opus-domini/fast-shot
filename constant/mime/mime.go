...
const (
	...
	ExcelMacroEnabled        Type = "application/vnd.ms-excel.sheet.macroEnabled.12"
	...
	PNG                      Type = "image/png"
	PowerPointMacroEnabled   Type = "application/vnd.ms-powerpoint.presentation.macroEnabled.12"
	PowerPointSlideshow      Type = "application/vnd.openxmlformats-officedocument.presentationml.slideshow"
	...
	WordMacroEnabled         Type = "application/vnd.ms-word.document.macroEnabled.12"
	WordTemplate             Type = "application/vnd.openxmlformats-officedocument.wordprocessingml.template"
	XHTML                    Type = "application/xhtml+xml"
	XML                      Type = "application/xml"
	XUL                      Type = "application/vnd.mozilla.xul+xml"
	YAML                     Type = "application/yaml"
